                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                {account.ensAvatar ? (
                                                    ...
                                                    <div
                                                        style={{
                                                            backgroundImage: `url(${blo(account.address as `0x${string}`)})`,
                                                        }}
                                            ...
                                            {/* Dropdown Box */}
                                            <div
                                                className={`absolute right-0 top-full mt-2 w-60 sm:w-72 bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden z-50 transition-all duration-150 ease-out font-sans ${
                                                    isHovering || isOpen
                                                ...
                                                <div className='px-4 py-3 border-b border-gray-100 bg-gray-50/50'>
                                                    <div className='flex items-center justify-between'>
                                                        ...
                                                        <div className='flex items-center gap-2'>
                                                            ...
                                                            <span className='text-gray-900 font-medium text-sm font-display'>
                                                                {chain.name}
                                                            </span>
                                                        </div>
                                                    </div>
